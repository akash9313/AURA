"""
Reflection Engine Domain Models.
Defines RecommendationType, Recommendation, PatternInsight, TaskMetric, and ReflectionReport.
Analyzes completed workflows and generates recommendations without directly modifying code.
"""
...
class RecommendationType(Enum):
    """Types of actionable recommendations generated by Reflection Engine."""
...
class Recommendation:
    """Actionable recommendation with confidence score and supporting evidence."""
...
class PatternInsight:
    """Detected recurring behavior pattern across workflow runs."""
...
@dataclass
class TaskMetric:
    """Performance and telemetry metrics for a single task."""
    task_id: str
    capability: str
    duration_ms: float
    retries: int
...
class ReflectionReport:
    """Complete reflection report analyzing workflow execution and recommending improvements."""
