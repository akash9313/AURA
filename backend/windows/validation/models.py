"""
Desktop Capability Validation Domain Models.
Defines DesktopValidationStatus, DesktopTaskResult, DesktopMissionResult, and DesktopValidationMetrics.
"""
...
class DesktopValidationStatus(Enum):
    """Status of desktop capability validation."""
    PENDING = "pending"
    RUNNING = "running"
    PASSED = "passed"
    FAILED = "failed"
...
class DesktopTaskResult:
    """Result of an individual desktop task step execution."""
    task_name: str
    capability_name: str
...
class DesktopMissionResult:
    """Master result model for a Desktop Test Mission."""
    mission_id: str
    mission_name: str
    status: DesktopValidationStatus = DesktopValidationStatus.PENDING
...
class DesktopValidationMetrics:
    """Aggregated validation report metrics across all desktop test missions."""
