"""
Planner Task Builder & Factory.
Constructs validated PlannerTask nodes with inputs, outputs, verification rules, and retry policies.
"""
...
class TaskBuilder:
    """
    Builder for constructing PlannerTask instances.
    """
    ...
    def build(self) -> PlannerTask:
        logger.debug(f"Built PlannerTask '{self._task.task_id}' ({self._task.capability_required})")
        return self._task
