"""
Mission Memory Integration Service.
Top-level AURA service integrating Mission Memory into the EventBus, Goal Verification, Reflection, and AI Planner.
Stores completed workflow operational experience independent from conversation memory.
"""
...
class MissionMemoryIntegrationService(Service):
    """
    Service wrapper integrating Operational Mission Memory with AI Planner and EventBus.
    """
    ...
    def __init__(
        ...
        logger.info("MissionMemoryIntegrationService initialized")

    def start(self) -> None:
        """Start service and subscribe to EventBus workflow completion channels."""
        logger.info("Starting MissionMemoryIntegrationService...")
        if self.bus:
    ...
    def stop(self) -> None:
        """Stop service."""
        logger.info("Stopping MissionMemoryIntegrationService...")
    ...
    def _on_workflow_completed(self, payload: Any) -> None:
        """Handle completed workflow event and store operational knowledge record."""
    ...
    def store_operational_mission(
        ...
        """
        Store completed or failed workflow as an OperationalMissionRecord.

        Returns:
            Saved OperationalMissionRecord instance.
        """
    ...
    def search_similar_missions_for_planner(self, goal_query: str, top_k: int = 5) -> List[MissionSearchResult]:
        """
        Expose operational memory retrieval for AI Planner.

        Returns:
            List of MissionSearchResult items.
        """
