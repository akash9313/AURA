"""
Mission Memory Engine Domain Models.
Defines MissionRecord, MissionExperience, and MissionCheckpointRecord.
Stores operational execution knowledge to help Planner reuse prior experiences.
"""
...
@dataclass
class MissionRecord:
    """Full operational record of an executed mission/workflow."""
...
class MissionExperience:
    """Distilled experience model for AI Planner knowledge reuse."""
...
class MissionCheckpointRecord:
    """Checkpoint operational snapshot for workflow pause/resume."""
