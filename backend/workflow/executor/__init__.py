"""
AURA Workflow Execution Engine Subsystem (`backend/workflow/executor/`).
Executes validated task graphs generated by the AI Planner with parallel scheduling, timeouts, cancellation, checkpoints, and retries.
"""
