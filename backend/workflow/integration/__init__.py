"""
AURA Workflow Executor Integration Subsystem (`backend/workflow/integration/`).
Coordinates capability execution strictly through Capability Registry, Interaction Engine,
progress reporting, empirical verification, recovery, and final result reporting.
"""
