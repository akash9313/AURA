"""
Graph Node Builder.
Constructs validated GraphNode instances using the Builder Pattern.
"""
...
class NodeBuilder:
    """
    Builder Pattern for GraphNode instances.
    """
    ...
    def build(self) -> GraphNode:
        logger.debug(f"Built GraphNode '{self._node.task_id}' ({self._node.name})")
        return self._node
