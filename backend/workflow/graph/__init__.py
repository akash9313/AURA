"""
AURA Task Graph Engine Subsystem (`backend/workflow/graph/`).
Converts Planner output into dependency-aware Directed Acyclic Graphs (DAG) for execution ordering, parallel scheduling, critical path analysis, and recovery checkpoints.
"""
