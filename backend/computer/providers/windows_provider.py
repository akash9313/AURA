"""
Windows Desktop Automation Provider.
Implements platform-independent desktop automation interfaces for Windows OS.
Encapsulates Win32 APIs, UI Automation, application processes, input devices, and clipboard.
"""
