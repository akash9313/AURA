"""
Screen Intelligence Engine Domain Models.
Defines VisualElementType, VisualElement, OCRResult, ScreenSnapshot, and VisualVerificationResult.
Independent of Microsoft UI Automation or vendor-specific vision libraries.
"""
...
class VisualElementType(Enum):
    """Supported visual element types detected on screen."""
    BUTTON = "button"
    TEXT = "text"
    ICON = "icon"
    MENU = "menu"
...
@dataclass
class VisualElement:
    """Platform-independent Visual UI Element domain model."""
...
@dataclass
class OCRResult:
    """Extracted text bounding box result from OCR Provider."""
    text: str
...
class ScreenSnapshot:
    """Domain model representing a captured screen frame snapshot."""
...
class VisualVerificationResult:
    """Verification comparison result of pre- and post-action screen states."""
    changed: bool
    diff_score: float  # 0.0 to 1.0 difference score
    action_name: str
    message: str
